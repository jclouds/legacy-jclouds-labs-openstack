...
public interface UserApi {
   ...
   boolean create(@PathParam("instanceId") String instanceId, @PayloadParam("users") Set<User> users);
   ...
   @Fallback(FalseOnNotFoundOr404.class)
   @MapBinder(BindCreateUserToJson.class)
   boolean create(@PathParam("instanceId") String instanceId, @PayloadParam("name") String userName, @PayloadParam("password") String password, @PayloadParam("databaseName") String databaseName);
   ...
   @Named("user:grant")
   @PUT
   @Path("/instances/{instanceId}/users/{name}/databases")
   @Consumes(MediaType.APPLICATION_JSON)
   @Fallback(FalseOnNotFoundOr404.class)
   @MapBinder(BindGrantUserToJson.class)
   boolean grant(@PathParam("instanceId") String instanceId, @PathParam("name") String userName, @PayloadParam("databases") Set<Database> databases);
   ...
   @Fallback(FalseOnNotFoundOr404.class)
   @MapBinder(BindGrantUserToJson.class)
   boolean grant(@PathParam("instanceId") String instanceId, @PathParam("name") String userName, @PayloadParam("databaseName") String databaseName);
   ...
   @Named("user:revoke")
   @DELETE
   @Path("/instances/{instanceId}/users/{name}/databases/{databaseName}")
   @Consumes(MediaType.APPLICATION_JSON)
   @Fallback(FalseOnNotFoundOr404.class)
   boolean revoke(@PathParam("instanceId") String instanceId, @PathParam("name") String userName, @PathParam("databaseName") String databaseName);
   ...
   @DELETE
   @Path("/instances/{instanceId}/users/{name}")
   @Consumes(MediaType.APPLICATION_JSON)
   @Fallback(FalseOnNotFoundOr404.class)
   boolean delete(@PathParam("instanceId") String instanceId, @PathParam("name") String userName);
   ...
   @GET
   @Path("/instances/{instanceId}/users/{name}/databases")
   @SelectJson("databases")
   @Consumes(MediaType.APPLICATION_JSON)
   @Fallback(EmptyFluentIterableOnNotFoundOr404.class)
   FluentIterable<Database> getDatabaseList(@PathParam("instanceId") String instanceId, @PathParam("name") String userName);
   ...
   @Nullable
   User get(@PathParam("instanceId") String instanceId, @PathParam("name") String userName);
}
